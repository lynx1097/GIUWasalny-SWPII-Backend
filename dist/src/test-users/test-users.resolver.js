...
const test_users_service_1 = require("./test-users.service");
const test_users_entity_1 = require("./test-users.entity");
...
__decorate([
    (0, graphql_1.Query)(() => [test_users_entity_1.TestUser], { name: 'testUsers' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], TestUsersResolver.prototype, "getTestUsers", null);
__decorate([
    (0, graphql_1.Query)(() => test_users_entity_1.TestUser, { name: 'testUser' }),
...
__decorate([
    (0, graphql_1.Mutation)(() => test_users_entity_1.TestUser),
...
exports.TestUsersResolver = TestUsersResolver = __decorate([
    (0, graphql_1.Resolver)(() => test_users_entity_1.TestUser),
    __metadata("design:paramtypes", [test_users_service_1.TestUsersService])
], TestUsersResolver);
//# sourceMappingURL=test-users.resolver.js.map